<?php
// Método mais compatível para iniciar a sessão (só inicia se não houver uma)
if (session_id() === '') {
    session_start();
}
?>
        ...
        <div class="collapse navbar-collapse" id="menuPrincipal">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="menuSubmissoes">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="menuAtividades">
            ...
            <div class="d-flex">
                <?php if (isset($_SESSION['usuario'])): // Se estiver logado ?>
